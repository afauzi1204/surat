<marquee>
  <strong>
    <h4>
    <?php echo ucwords(strtolower("SELAMAT DATANG DI SISTEM APLIKASI SURAT MASUK, KELUAR & DISPOSISI ")); 
    echo strtoupper($data['lembaga']) ?>
    ...
    <section class="content">
     ...
     <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-olive">
            ...
            <a href="?page=klasifikasi" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="?page=asal_tujuan" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
     ...
     <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-maroon">
            ...
            <a href="?page=m_dispos" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
     ...
     <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="?page=pimpinan" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
