...
<div class="user-panel">
  <div align="center">
  <h5 style="color: white; font-size: 14px; text-align: center;"><?php echo strtoupper($data['lembaga']); ?></h5>
  <img src="images/<?php echo $data['foto']; ?>" width="150" height="150" >
  <h5 style="color:white; font-size: 14px; text-align: center; "><?php echo strtoupper($data['kota']); ?></h5>
